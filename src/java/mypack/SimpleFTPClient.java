...
public class SimpleFTPClient
{
   ...
   public synchronized boolean uploadFile(InputStream is)
   {
        try
        {
			...
			FileOutputStream fos1=new FileOutputStream("d:/cloud/encripttest.txt");
			...
			int readCount=0;
			 ...
			 while ((readCount1 = bis.read(buffer1)) > 0)
			 {
				...
				FileInputStream fis = new FileInputStream("d:/cloud/encripttest.txt");
				
				FileOutputStream fos = new FileOutputStream("d:/cloud/encryptedtest.txt");
				
				encrypt(key, fis, fos);

				FileInputStream fis2 = new FileInputStream("d:/cloud/encryptedtest.txt");
    ...
    public synchronized boolean downloadFile(String localfilename)
	{
        try
        {
			...
			FileOutputStream fos1 = new FileOutputStream("d:/cloud/decripttest.txt");
			 ...
			 FileInputStream fis2 = new FileInputStream("d:/cloud/decripttest.txt");
